	...
	private async Task OverwriteModel()
	{
		var resourceLocations = new
		{
			Resources = new[]
			{
				new
				{
					Name = "Your EndpointResourceName Here",
					Location = new AzureBlobDataReference()
					{
						BaseLocation = "Your EndpointBaseLocation Here",
						RelativeLocation = "Your EndpointRelativeLocation Here",
						SasBlobToken = "Your EndpointSasBlobToken Here"
					}
				}
			}
		};
